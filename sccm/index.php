    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 d-flex justify-content-center flex-column">
                <h2>SCCM 2023</h2>
                <p>53rd Critical Care Congress of the Society of Critical Care Medicine</p>
                <div class="button-box">
                    <div class="btn btn-primary">Registration</div>
                    <div class="btn btn-primary">Housing</div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 about-content">
                <h5>About</h5>
                <h2>Welcome to SCCM 2023</h2>
                <p>SCCM returns to in-person learning January 21-24, 2023, at the Moscone Center South in San
                    Francisco, California.</p>
                <ul>
                    <li>Network and collaborate with colleagues and critical care experts from around the world</li>
                    <li>Explore the latest research, knowledge, tools, and technologies that improve patient care
                    </li>
                    <li>Unwind, have fun, and gather with friends in the vibrant and distinctive San Francisco
                        culture</li>
                    <li>Gain access to Congress Digital, which includes additional CE/ACE and MOC opportunities</li>
                </ul>
            </div>
            <div class="col-md-6 about-image">
                <img class="main-image" src="./assets/about.png" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="item d-flex align-items-center justify-content-center flex-column">
                    ...
                    <h3>Moscone Center South, San Francisco, CA, USA</h3>
                    <h4>Venue</h4>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="information-content">
                    ...
                    <p>
                        The Society of Critical Care Medicine (SCCM) is the largest nonprofit medical organization
                        dedicated to promoting excellence and consistency in the practice of critical care.
                        With members in more than 100 countries, SCCM is the only organization that represents all
                        professional components of the critical care team. The Society offers a variety of activities
                        that ensure excellence in patient care, education, research, and advocacy.
                    </p>
                </div>
            </div>
        </div>
